...
class CustomerDetails extends Component {
    ...
    sendOrderDetails = event => {
        ...
        let bookIdList = [];
        for (let i = 0; i < JSON.parse(localStorage.getItem("abc")).length; i++) {
            bookIdList.push(JSON.parse(localStorage.getItem("abc"))[i].id)
        }
